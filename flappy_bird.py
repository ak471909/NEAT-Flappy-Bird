...
BIRD_IMGS = [
    pygame.transform.scale2x(pygame.image.load(os.path.join("C:/Users/surya/Desktop/flappyBird_with_NEAT_algo/bird1.png"))),
    pygame.transform.scale2x(pygame.image.load(os.path.join("C:/Users/surya/Desktop/flappyBird_with_NEAT_algo/bird2.png"))),
    pygame.transform.scale2x(pygame.image.load(os.path.join("C:/Users/surya/Desktop/flappyBird_with_NEAT_algo/bird3.png")))
]
PIPE_IMG = pygame.transform.scale2x(pygame.image.load(os.path.join("C:/Users/surya/Desktop/flappyBird_with_NEAT_algo/pipe.png")))
BASE_IMG = pygame.transform.scale2x(pygame.image.load(os.path.join("C:/Users/surya/Desktop/flappyBird_with_NEAT_algo/base.png")))
BG_IMG = pygame.transform.scale2x(pygame.image.load(os.path.join("C:/Users/surya/Desktop/flappyBird_with_NEAT_algo/bg.png")))
